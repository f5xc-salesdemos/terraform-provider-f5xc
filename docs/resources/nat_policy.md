...
- `rules` (Block List) Rule. List of rules to apply under the NAT Policy. Rule that matches first would be applied Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 64 (see [below for nested schema](#nestedblock--rules))
...
- `name` (String) Name. Name of the Rule Required: YES ves.io.schema.rules.message.required: true
...
- `refs` (Block List) Cloud Connect. Reference to Cloud Connect Object Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 1 (see [below for nested schema](#nestedblock--rules--cloud_connect--refs))
...
- `destination_cidr` (List of String) Destination IP. Destination IP of the packet to match ves.io.schema.rules.string.ip_prefix: true
...
- `protocol` (String) Protocols. Protocols like TCP, UDP
...
- `source_cidr` (List of String) Source IP. Source IP of the packet to match ves.io.schema.rules.string.ip_prefix: true
...
- `refs` (Block List) Segment. Reference to Segment Object Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 1 (see [below for nested schema](#nestedblock--rules--criteria--segment--refs))
...
- `refs` (Block List) Virtual Network Reference. Reference to virtual network ves.io.schema.rules.repeated.max_items: 1 (see [below for nested schema](#nestedblock--rules--criteria--virtual_network--refs))
...
- `refs` (Block List) Network Interface. Reference to Network Interface Object Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 1 (see [below for nested schema](#nestedblock--rules--network_interface--refs))
...
- `refs` (Block List) Segment. Reference to Segment Object Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 1 (see [below for nested schema](#nestedblock--rules--segment--refs))
...
- `refs` (Block List) Virtual Network Reference. Reference to virtual network ves.io.schema.rules.repeated.max_items: 1 (see [below for nested schema](#nestedblock--rules--virtual_network--refs))
...
- `refs` (Block List) Site. Reference to Site Object Required: YES ves.io.schema.rules.message.required: true (see [below for nested schema](#nestedblock--site--refs))
